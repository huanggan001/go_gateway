...
func (s *LoadBalanceCheckConf) Attach(o Oberver) {
	s.observers = append(s.observers, o)
}

func (s *LoadBalanceCheckConf) NotifyAllObervers() {
...
func (s *LoadBalanceCheckConf) WatchConf() {
	...
	go func() {
		...
		for {
			...
			//fmt.Println("changedList:", changedList)
			//fmt.Println("s.activeList:", s.activeList)
